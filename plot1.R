...
# Plot part
png(filename='./Coursera/ExploratoryAnalysis/ExData_Plotting1/plot1.png',width=480,height=480,units='px')

hist(power_consum_selected$Global_active_power,main='Global Active Power',xlab='Global Active Power (kilowatts)',col='red')
